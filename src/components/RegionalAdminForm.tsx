...
export default function RegionalAdminForm(props: { titleAddress: string }) {
	const {
		register: registerAdmin,
		handleSubmit: handleSubmitAdmin,
		watch,
        formState,
		formState: { errors: errorsAdmin, isSubmitSuccessful },
        reset
	} = useForm<InputsAdmin>({
		mode: 'onChange',
	...
	const onSubmitAdmin: SubmitHandlerAdmin<InputsAdmin> = () => {
		write?.();
	};
